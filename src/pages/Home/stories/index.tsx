...
const Stories = () => {
  return (
    <div className="mx-6 md:mx-[55px] my-[200px] flex flex-col items-center">
      <p className="text-[38px] font-bold tracking-tight pb-6">Real Stories from Satisfied Customers</p>
      <p className="font-Mulish text-[21px]">See how we help students, researchers and professionals manage their data effectively.</p>
